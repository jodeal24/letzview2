...
const MESSAGES = {
  en: {
    ...
    familyTagline: "Stories Made for Little Eyes",
  ...
  fr: {
    ...
    familyTagline: "Des histoires faites pour les petits yeux curieux",
  ...
  de: {
    ...
    familyTagline: "Geschichten für kleine Kinderaugen",
  ...
  lb: {
    ...
    familyTagline: "Geschichte fir kleng virwëtzeg Aen",
